...
const PostJob = () => {
    ...
    return <div data-aos="zoom-out" className="px-16 bs-mx:px-10 md-mx:px-5 py-5 ">
        <div className="text-2xl font-semibold mb-5 text-gray-800">Post a Job</div>
        <div className="flex flex-col gap-5">
            ...
            <div className="[&_button[data-active='true']]:!text-purple-600 [&_button[data-active='true']]:!bg-purple-100">
                <div className="text-sm font-medium text-gray-800">Job Description<span className="text-red-600 "> *</span></div>
                <TextEditor data-aos="zoom-out"  form={form} data={editorData}/>
            </div>
            <div   className="flex gap-4">
                <Button data-aos="zoom-out" className="!bg-gradient-to-r !from-purple-500 !to-pink-500 !text-white hover:!from-purple-600 hover:!to-pink-600 !border-0" onClick={handlePost} variant="filled">Publish Job</Button>
                <Button data-aos="zoom-out" className="!border-purple-500 !text-purple-600 hover:!bg-purple-50" onClick={handleDraft} variant="outline">Save as Draft</Button>
            </div>
        </div>
    </div>
}
