...
const Info = () => {
    ...
    return <><div data-aos="zoom-out" className="text-3xl xs-mx:text-2xl font-semibold flex justify-between text-gray-800">{user.name} <div>
        ...
        <ActionIcon onClick={handleClick} variant="subtle" color={edit ? "red.8" : "purple.6"} size={matches?"md":"lg"} >
    ...
    </div>
        {
            ...
            <div data-aos="zoom-out" className=" flex gap-10 md-mx:gap-5 [&>*]:w-1/2 xs-mx:[&>*]:w-full xs-mx:flex-wrap my-3" >
                ...
                <>
                    <div  className="text-xl xs-mx:text-base flex gap-1 items-center text-gray-800"> <IconBriefcase className="h-5 w-5" stroke={1.5} />{profile.jobTitle}  &bull; {profile.company}</div>
                    <div className="text-lg xs-mx:text-base flex gap-1 items-center text-gray-600">
