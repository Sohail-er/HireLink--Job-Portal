    ...
    return (
        <div className="min-h-[90vh] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 font-['poppins'] p-4  ">
            <Divider size="xs" mx="md" />
                <Button my="sm" onClick={()=>navigate(-1)} className="!bg-purple-100 !text-purple-600 hover:!bg-purple-200" leftSection={<IconArrowLeft size={20} />} variant="light">Back</Button>
