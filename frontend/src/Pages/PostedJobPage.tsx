...
const PostedJobPage = () => {
    ...
    return (
        <div className="min-h-[90vh] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 font-['poppins'] px-5  ">
            <Divider />
            {matches&&<Button my="xs" size="sm" className="!bg-gradient-to-r !from-purple-500 !to-pink-500 !text-white hover:!from-purple-600 hover:!to-pink-600 !border-0" onClick={open}>All Jobs</Button>}
