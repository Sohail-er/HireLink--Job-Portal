...
const ApplyJobPage = () => {
    ...
    return <div className="min-h-[90vh] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 font-['poppins'] p-4">
        <Divider size="xs" mb="xs" />
            <Button className="!bg-purple-100 !text-purple-600 hover:!bg-purple-200" mb="xs" onClick={()=>navigate(-1)} leftSection={<IconArrowLeft size={20} />} variant="light">Back</Button>
